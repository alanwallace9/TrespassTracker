...
export async function getCampuses(tenantId?: string): Promise<Campus[]> {
  try {
    ...
    logger.error('[getCampuses] Error', { error: error.message });
    throw error;
  }
}
...
export async function isCampusNameUnique(name: string, excludeCampusId?: string): Promise<boolean> {
  try {
    ...
    logger.error('[isCampusNameUnique] Error', { error: error.message });
    throw error;
  }
}
...
export async function createCampus(campusData: {
  ...
  try {
    ...
    logger.error('[createCampus] Error', { error: error.message });
    throw error;
  }
}
...
export async function updateCampus(
  ...
  try {
    ...
    logger.error('[updateCampus] Error', { error: error.message });
    throw error;
  }
}
...
export async function getCampusById(campusId: string): Promise<Campus> {
  try {
    ...
    logger.error('[getCampusById] Error', { error: error.message });
    throw error;
  }
}
...
export async function canDeactivateCampus(campusId: string): Promise<{
  ...
  try {
    ...
    logger.error('[canDeactivateCampus] Error', { error: error.message });
    throw error;
  }
}
...
export async function deactivateCampus(campusId: string): Promise<void> {
  try {
    ...
    logger.error('[deactivateCampus] Error', { error: error.message });
    throw error;
  }
}
...
export async function activateCampus(campusId: string): Promise<void> {
  try {
    ...
    logger.error('[activateCampus] Error', { error: error.message });
    throw error;
  }
}
