      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-lg overflow-hidden">
            <div className="grid grid-cols-[1fr,auto,1fr] gap-4 p-4 bg-slate-100 border-b font-semibold text-sm">
              <div>CSV Column</div>
            ...
            <div className="divide-y">
              {csvHeaders.map((csvHeader, index) => {
                ...
                return (
                  <div key={index} className="grid grid-cols-[1fr,auto,1fr] gap-4 p-4 items-center hover:bg-slate-50">
                    <div className="font-medium text-sm">{csvHeader}</div>
                        ...
                        <SelectContent>
                          ...
                          {currentMapping && currentMapping !== 'skip' && !availableFields.find(f => f.value === currentMapping) && mappedField && (
                            <SelectItem value={currentMapping}>
                              {mappedField.label} {mappedField.required && <span className="text-red-500">*</span>}
                            </SelectItem>
                          )}
                        </SelectContent>
                      </Select>
